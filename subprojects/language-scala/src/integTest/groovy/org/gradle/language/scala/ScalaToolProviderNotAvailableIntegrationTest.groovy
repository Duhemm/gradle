...
class ScalaToolProviderNotAvailableIntegrationTest extends AbstractIntegrationSpec {
    ...
    def "provide decent error message when scala tools not available"() {
        ...
        fails("assemble")
        then:
        errorOutput.contains("Cannot provide Scala Compiler: Cannot resolve external dependency org.scala-lang:scala-compiler:2.10.5 because no repositories are defined.")
